	...
	<body>
		...
		<div class="content">
			...
			<div class="left">
				...
				<h2>Academics</h2>
				<p> I am double majoring in Film and Media Studies and Digital Media Studies with a minor in Computer Science.</p>
			...
			<div class="right">
				...
				<h2>Interests</h2>
				<p> I have been thinking recently about what exactly I would like to do and where I would like to be. I know for a fact that I want to live and work somewhere with winters that are noticeably warmer than those in Rochester. I am interested in film, media, web design, public relations, and marketing, which are skills that I think can be combined easily. I would love to work in media marketing and helping companies grow their brand.</p>
